...
namespace Nop.Plugin.Widgets.Employees.Data
{
    ...
    {
        #region Ctor
        public EmployeesObjectContext(string nameOrConnectionString)
        ...
        {
            modelBuilder.Configurations.Add(new EmployeesRecordMap());
            modelBuilder.Configurations.Add(new DepartmentRecordMap());
